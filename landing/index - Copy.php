    ...
    <div class="main-wrapper">
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown" class="nav-link notification-toggle nav-link-lg "><i class="ion ion-person" style="font-size: 120%" > Sign Up</i></a>
            <div class="dropdown-menu dropdown-list dropdown-menu-right">
            </div>
          </li>
          <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown" class="nav-link notification-toggle nav-link-lg "><i class="ion ion-log-in" style="font-size: 120%" > Sign In</i></a>
            <div class="dropdown-menu dropdown-list dropdown-menu-right">
            </div>
          </li>
        </ul>
