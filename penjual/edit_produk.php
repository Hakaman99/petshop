              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <tbody>
                    ...
                    ?>
                    <form enctype="multipart/form-data" action="process/update_produk.php" method="POST">
                    <tr>
                      <input type="hidden" name="id" value="<?=$row['id']?>">
                      <td><input class="form-control" type="text" name="nama" value="<?=$row['nama'] ?>"></td>
                      <td><input class="form-control" type="text" name="kategori" value="<?=$row['kategori']?>"></td>
                      <td><input class="form-control" type="text" name="fungsi" value="<?=$row['fungsi']?>"></td>
                      <td><input class="form-control" type="number" name="harga" value="<?=$row['harga']?>"></td>
                      <td><input class="form-control" type="number" name="stok" value="<?=$row['stok']?>"></td>
                      <td><input type="file" name="gambar" class="form-control"></td>
                      <input type="hidden" name="gbr" value="<?=$row['gambar']?>">
                   </tr>
                   ...
                   <tr>
                      <td colspan="6"><textarea type="textarea" style="width: 100%;height: 100px" name="deskripsi"><?=$row['deskripsi']?></textarea></td>
                   </tr>
